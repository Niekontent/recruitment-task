...
config :phoenix_api, PhoenixApiWeb.Endpoint,
  ...
  secret_key_base: "RZVfu2hoIAU3sX2AmkNnBErIvLbUSiav104o6qj3SGSKYchIo99T7nNHzM/yIZCt",
  server: false
...
config :phoenix_api, :import_users, PhoenixApi.Application.ImportUsersMock
